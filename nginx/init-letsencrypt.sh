...
rsa_key_size=4096
data_path="./certbot"
email="admin@networking-sesc.ru" # Замените на ваш email
staging=0 # Установите в 1 для тестирования

if [ -d "$data_path" ]; then
  read -p "Существующие данные найдены в $data_path. Продолжить и заменить существующий сертификат? (y/N) " decision
